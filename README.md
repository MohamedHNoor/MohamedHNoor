...
I am an experienced and driven Full Stack Web Developer with mastery in React.js, Redux, Next.js,  Node.js, Express.js, and Ruby on Rails. I have a proven track record of creating engaging and user-friendly web applications and thrive in dynamic and collaborative environments. I constantly seek new opportunities to grow and challenge myself with complex projects pushing these cutting-edge technologies' boundaries.
